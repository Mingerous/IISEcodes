...
# 假设Rolling 过程中所有被占用车位 Gx 按比例  0.1、 0.25、 0.3、 0.25、 0.1 返回
P = pd.DataFrame({
    0: np.array([0, 0, 0.65, 0.25, 0.1], dtype='float32'),
    1: np.array([0, 0.25, 0.4, 0.25, 0.1], dtype='float32'),
    2: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    3: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    4: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    5: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    6: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    7: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    8: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    9: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    10: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    11: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    12: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    13: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    14: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    15: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    16: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    17: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    18: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    19: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    20: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    21: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    22: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
    23: np.array([0.1, 0.25, 0.3, 0.25, 0.1], dtype='float32'),
}, index=[-2, -1, 0, 1, 2])
PAI = pd.DataFrame({
    0: np.array([0, 0, 0.7, 0.2, 0.1], dtype='float32'),
    1: np.array([0, 0.2, 0.5, 0.2, 0.1], dtype='float32'),
    2: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    3: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    4: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    5: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    6: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    7: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    8: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    9: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    10: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    11: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    12: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    13: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    14: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    15: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    16: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    17: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    18: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    19: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    20: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    21: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    22: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
    23: np.array([0.1, 0.2, 0.4, 0.2, 0.1], dtype='float32'),
}, index=[-2, -1, 0, 1, 2])
...
def Get_Xtk(tao, Ctao, Dtao, Gxdelay):
    ...
    for n in Samples:
        for t in Yperiods:
            ...
            if t == tao + 1:
                if t <= 22:
                    Gydelay[n, t, -2] = Mx[2] * PAI.loc[-2, 2]
                else:
                    Gydelay[n, t, -2] = 0
                Gydelay[n, t, -1] = Mx[1] * PAI.loc[-1, 1]
                Gydelay[n, t, 0] = Mx[0] * PAI.loc[0, 0]
                Gydelay[n, t, 1] = 0
                Gydelay[n, t, 2] = 0
            elif t == tao + 2:
                if t <= 22:
                    Gydelay[n, t, -2] = Mx[t - tao + 1] * PAI.loc[-2, t - tao + 1] + gp.quicksum(
                            My[n, e, t - e + 1] * PAI.loc[-2, t - e + 1] for e in range(tao + 1, t))
                else:
                    Gydelay[n, t, -2] = 0
                Gydelay[n, t, -1] = Mx[t - tao] * PAI.loc[-1, t - tao] + gp.quicksum(
                            My[n, e, t - e] * PAI.loc[-1, t - e] for e in range(tao + 1, t))
            ...
            Gy[n, t] = Gydelay[n, t, -2] + Gydelay[n, t, -1] + Gydelay[n, t, 0] + Gydelay[n, t, 1] + Gydelay[n, t, 2] + \
                       Gxdelay[t]
...
def Rolling(minute):
    ...
    for n in range(0, Num_of_Rolling_days):
        file = open("Files/" + str(minute) + "ValidInequalities/" + PRICE + "/N" + str(Num_of_SAA_samples) + "PAI" + str(
        ...
        M = {}
        Rtao = {}
        Gxdelay = pd.DataFrame(np.zeros(Num_of_periods*5).reshape(5, Num_of_periods))
        ...
        for tao in range(0, Num_of_decisions):
            ...
            if int(tao * minute / 30) == 0:
                Gxdelay.loc[int(tao * minute / 30), -2] = sum(Mtk[e, 2] * P.loc[-2, 2] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), -1] = sum(Mtk[e, 1] * P.loc[-1, 1] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), 0] = sum(Mtk[e, 0] * P.loc[0, 0] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), 1] = 0
                Gxdelay.loc[int(tao * minute / 30), 2] = 0
            elif int(tao * minute / 30) == 1:
                Gxdelay.loc[int(tao * minute / 30), -2] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30) + 2] * P.loc[
                        -2, int(tao * minute / 30) - int(e * minute / 30) + 2] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), -1] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30) + 1] * P.loc[
                        -1, int(tao * minute / 30) - int(e * minute / 30) + 1] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), 0] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30)] * P.loc[
                        0, int(tao * minute / 30) - int(e * minute / 30)] for e in range(0, tao + 1))
                Gxdelay.loc[int(tao * minute / 30), 1] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30) - 1] * P.loc[
                        1, int(tao * minute / 30) - int(e * minute / 30) - 1] for e in
                    range(0, tao + 1 - int(30 / minute)))
                Gxdelay.loc[int(tao * minute / 30), 2] = 0
            elif int(tao * minute / 30) == 23:
                Gxdelay.loc[int(tao * minute / 30), -2] = 0
                Gxdelay.loc[int(tao * minute / 30), -1] = 0
                Gxdelay.loc[int(tao * minute / 30), 0] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30)] * P.loc[
                ...
                Gxdelay.loc[int(tao * minute / 30), 2] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30) - 2] * P.loc[
                        2, int(tao * minute / 30) - int(e * minute / 30) - 2] for e in
                    range(0, tao + 1 - int(60 / minute)))
            elif int(tao * minute / 30) == 22:
                Gxdelay.loc[int(tao * minute / 30), -2] = 0
                Gxdelay.loc[int(tao * minute / 30), -1] = sum(
                    Mtk[e, int(tao * minute / 30) - int(e * minute / 30) + 1] * P.loc[
                        -1, int(tao * minute / 30) - int(e * minute / 30) + 1] for e in range(0, tao + 1))
            ...
            if tao%(30/minute) == 30/minute - 1:
                Gt = round(
                    Gxdelay.loc[int(tao * minute / 30), -2] + Gxdelay.loc[int(tao * minute / 30), -1] + Gxdelay.loc[
                        int(tao * minute / 30), 0] + Gxdelay.loc[int(tao * minute / 30), 1] + Gxdelay.loc[
                        int(tao * minute / 30), 2])
            else:
                Gt = 0
            ...
            for t in range(int((tao + 1) * minute / 30) + 1, Num_of_periods):
                ...
                if t == int((tao + 1) * minute / 30) + 1:
                    if t >= Num_of_periods - 2:
                        G[-2] = 0
                    else:
                        G[-2] = sum(Mtk[e, t - int(e * minute / 30) + 1] * PAI.loc[-2, t - int(e * minute / 30) + 1] for
                            e in range(0, tao + 1))
                    if t >= Num_of_periods - 1:
                        G[-1] = 0
                    else:
                        G[-1] = sum(Mtk[e, t - int(e * minute / 30)] * PAI.loc[-1, t - int(e * minute / 30)] for e
                            in range(0, tao + 1))
                    G[0] = sum(Mtk[e, t - int(e * minute / 30) - 1] * PAI.loc[0, t - int(e * minute / 30) - 1]
                        for e in range(0, tao + 1))
                    G[1] = sum(
                        Mtk[e, t - int(e * minute / 30) - 2] * (1 - P.loc[0, t - int(e * minute / 30) - 2]) * PAI.loc[
                    ...
                    G[2] = sum(
                        Mtk[e, t - int(e * minute / 30) - 3] - Mtk[e, t - int(e * minute / 30) - 3] * P.loc[
                            0, t - int(e * minute / 30) - 3] -
                        Mtk[e, t - int(e * minute / 30) - 3] * P.loc[1, t - int(e * minute / 30) - 3] for e in
                    ...
                    G[2] = sum(Mtk[e, t - int(e * minute / 30) - 3] - Mtk[e, t - int(e * minute / 30) - 3] * PAI.loc[
                        0, t - int(e * minute / 30) - 3] -
                               Mtk[e, t - int(e * minute / 30) - 3] * PAI.loc[1, t - int(e * minute / 30) - 3]
                               for e in range(0, tao + 1))
                Gx[t] = round(G[-2] + G[-1] + G[0] + G[1] + G[2])
            print(Gx)
    ...
    f = open(
        "Files/" + str(minute) + "ValidInequalities/" + PRICE + "/N" + str(Num_of_SAA_samples) + "PAI" + str(
            len(PAI.index)) + "C" + str(C0) + "h" + str(
            h) + "beta" + str(beta) + ".txt", "a")
